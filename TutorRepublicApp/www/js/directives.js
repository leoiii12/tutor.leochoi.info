        ...
        link: function (scope, element, attrs, parent) {
            ...
            var init = function () {
                ...
                if (options.slideTabsScrollable) {
                    ...
                    tabsBar = angular.element('<ion-scroll delegate-handle="' + ionicScrollDelegateID + '" class="slidingTabs" direction="x" scrollbar-x="false"><ul>' + tabItems + '</ul><div class="tab-indicator-wrapper"><class="tab-indicator"></div></div></ion-scroll>');
                }
                else {
            ...
            var addEvents = function () {
                ...
                window.addEventListener("resize", setTabBarWidth, true);

            };

            var setTabBarWidth = function () {
                // Set content scroll height
                scrollDiv = slider[0].getElementsByClassName("slider-slide");
                for (var i = 0; i < scrollDiv.length; i++) {
                    angular.element(scrollDiv[i].children[0]).css("height", (document.documentElement.clientHeight - 48 - 44) + "px");
                }
            ...
            scope.addTabContent = function ($content) {
                ...
                $timeout(function () {
                    ...
                    slideToCurrentPosition();
                    setTabBarWidth();
                    angular.element(tabsBar[0].querySelector("ul")).css("display", "block");
                });
